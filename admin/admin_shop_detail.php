...
<head>
    ...
    <title>Category Profile | Food Frenzy</title>
</head>
    ...
    <div class="container px-5 py-4" id="shop-body">
        ...
        <?php
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                    ...
                    <span class="ms-2 mt-2">Successfully updated category password.</span>
                </div>
            </div>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                    <i class="bi bi-x-circle ms-2"></i><span class="ms-2 mt-2">Failed to update category password.</span>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col m-2 p-2 bg-danger text-white rounded text-start">
                <i class="bi bi-x-circle ms-2"></i><span class="ms-2 mt-2">No menu found in this Category</span>
