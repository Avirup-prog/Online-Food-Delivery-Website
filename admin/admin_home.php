...
<head>
    ...
    <title>Admin Dashboard | Food Frenzy</title>
</head>
                    ...
                    <div class="card rounded-5 border-success p-2">
                        <div class="card-body">
                            ...
                            <p class="card-text my-2">
                                ...
                                food categorie(s) in the system
                            </p>
                            <div class="text-end">
                                <a href="admin_shop_list.php" class="btn btn-sm btn-outline-dark">Go to Food Category List</a>
                            </div>
                        </div>
                    </div>
                </a>
