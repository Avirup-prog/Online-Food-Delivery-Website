...
<head>
    ...
    <title>Add new shop | Food Frenzy</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto w-50">
        ...
        <form method="POST" action="admin_shop_add.php" class="form-floating" enctype="multipart/form-data">
            <h2 class="mt-4 mb-3 fw-normal text-bold"><i class="bi bi-pencil-square me-2"></i>Add New Category</h2>
            ...
            <button class="w-100 btn btn-success mb-3" name="add_confirm" type="submit">Add new Category</button>
        </form>
    </div>
